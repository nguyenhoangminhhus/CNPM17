				...
				<div class="single-page-row" id="detail-21">
					<div class="col-md-6 single-top-left">	
						<div class="flexslider">
							<ul class="slides">
								<li data-thumb="source/images/<?php echo e($sanpham->image); ?>">
									<div class="thumb-image detail_images"> <img src="source/images/<?php echo e($sanpham->image); ?>" data-imagezoom="true" class="img-responsive" alt=""> </div>
								</li>
								<li data-thumb="source/images/<?php echo e($sanpham->image); ?>">
									 <div class="thumb-image"> <img src="source/images/<?php echo e($sanpham->image); ?>" data-imagezoom="true" class="img-responsive" alt=""> </div>
								</li>
								<li data-thumb="source/images/<?php echo e($sanpham->image); ?>">
								   <div class="thumb-image"> <img src="source/images/<?php echo e($sanpham->image); ?>" data-imagezoom="true" class="img-responsive" alt=""> </div>
								</li> 
					...
					<div class="col-md-6 single-top-right">
						<h3 class="item_name"><?php echo e($sanpham->name); ?></h3>
						...
						<div class="single-price">
							<ul>
								<li><?php echo e(number_format($sanpham->unit_price)); ?> VNĐ</li>  
								<li><del><?php echo e(number_format($sanpham->promotion_price)); ?> VNĐ</del><span class="w3off"></span></li> 
							</ul>	
						</div> 
				...
				<div class="panel-group collpse" id="accordion" role="tablist" aria-multiselectable="true">
					<div class="panel panel-default">
						...
						<div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
							<div class="panel-body">
								<?php echo e($sanpham->description); ?>
					...
					<div class="panel panel-default">
						<div class="panel-heading" role="tab" id="headingThree">
							...
							<div class="panel-body">
								<?php if(Auth::check()): ?>
								<form  action="<?php echo e(route('comment')); ?>" method="POST" role="form">
