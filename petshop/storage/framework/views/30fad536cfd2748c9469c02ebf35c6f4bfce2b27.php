			...
			<div class="footer-info w3-agileits-info">
				<div class="col-md-4 address-left agileinfo">
					<div class="footer-logo header-logo">
						<h2><a href="<?php echo e(route('trang-chu')); ?>"><span>S</span>hopet<i> Corner</i></a></h2>
				...
				<div class="col-md-8 address-right">
					<div class="col-md-3 footer-grids">
						<h3>Company</h3>
						<ul>
							<li><a href="<?php echo e(route('thong-tin')); ?>">Về chúng tôi</a></li>
							<li><a href="<?php echo e(route('dich-vu')); ?>">Marketplace</a></li>  
					...
					<div class="col-md-3 footer-grids">
						<h3>Dịch vụ</h3>
						<ul>
							<li><a href="<?php echo e(route('lien-he')); ?>">Liên hệ với chúng tôi</a></li>
							<li><a href="<?php echo e(route('giup-do')); ?>">Hướng dẫn</a></li>
							<li><a href="<?php echo e(route('so-do-website')); ?>">Sơ đồ website</a></li>
						</ul> 
					</div>
