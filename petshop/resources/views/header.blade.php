	...
	<div class="header">
		...
		<div class="header-three"><!-- header-three -->
			<div class="container">
					...
					<div class="cd-dropdown-wrapper">
						...
						<nav class="cd-dropdown"> 
							...
							<ul class="cd-dropdown-content"> 
								<li><a href="offers.html">Khuyến mãi</a></li>
				...
				<div class="move-text">
					<div class="marquee"><a href="offers.html"> Bộ sưu tập mới có tại đây...... <span>Giảm 10% tất cả sản phẩm | Không có phụ phí </span> <span> Thử vận chuyển miễn phí trong 15 ngày với số lần không giới hạn</span></a></div>
